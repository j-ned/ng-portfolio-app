...
@Component({
  ...
  host: { class: 'block' },
  template: `
    <h1 class="text-2xl font-bold text-foreground mb-8">Blog</h1>
...
export class AdminBlog {
  readonly cards = [
    { icon: 'lucide-notebook-pen', label: 'Articles', route: '/admin/blog/articles' },
    { icon: 'lucide-message-square', label: 'Commentaires', route: '/admin/blog/comments' },
  ];
}
