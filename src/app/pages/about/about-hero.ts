  ...
  template: `
    ...
    >
      <div class="flex flex-col md:flex-row items-center md:items-start gap-6">
        <div
          class="relative w-32 h-32 md:w-58 md:h-58 rounded-2xl overflow-hidden border-4 border-foreground/10 shadow-xl flex-shrink-0"
        >
          <img
        ...
        <div class="flex-1 text-center md:text-left space-y-3">
          ...
          <div
            ...
            <div class="flex items-center gap-2">
              ...
              <span class="text-green-500 font-medium">{{ profileInfo.availabilityMessage }}</span>
            </div>
          </div>
